...
class ImageDataset(torch.utils.data.Dataset):
    def __init__(self, data_folder, im_input_size, mode='train'):
        self.max_label = 21
        self.resolution = im_input_size
        '''self.get_audio = False
        self.get_game_frame = True
        self.get_text_desc = False
        self.use_manual_annotation = False'''
        self.sample_every_n_frames = 12
        ...
        dataset_json_file = os.path.join(data_folder, f"{mode}.json")
    ...
    def modified_loader(self, idx):
        ...
        self.game.world_theme_n = random.randint(0, 5)     # select random background
        ...
        game_video = game_video.squeeze(0).permute(2,0,1)
        ...
        return self.transform(game_video), bg_label 
