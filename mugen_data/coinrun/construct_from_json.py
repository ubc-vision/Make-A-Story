...
def generate_asset_paths(game):
    ...
    ladyalien = 'kenneyLarge/Players/128x256_no_helmet/Blue/alienBlue'
    babyalien = 'kenneyLarge/Players/128x256_no_helmet/Pink/alienPink'
    alien_paths = {'Tony': alien, 'Lisa': ladyalien, 'Jhon' : babyalien}
    #alien_paths = {'Mugen': alien, 'LadyMugen': ladyalien, 'BabyMugen' : babyalien}
