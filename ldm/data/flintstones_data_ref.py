...
class VideoFolderDataset(torch.utils.data.Dataset):
    ...
    def story_dataset(self, data_folder, cache=None, min_len=3, mode='train'):
        ...
        for i in range(len(self.orders)):
            ...
            ref_count = ref_count + example['ref_count'] 
    ...
    def getSampleItem(self, item):
        ...
        for idx, globalID in enumerate(globalIDs):
            ...
            if idx == 0:
                ...
                imidiate_char = self.characters[globalID] #[x.lower() for x in self.characters[globalID]] 
                #break
                if "she" in text.lower() or "he" in text.lower() or "they" in text.lower():
