...
if __name__ == "__main__":
    ...
    config = OmegaConf.load("configs/latent-diffusion/flintstones_txt2img-1p4B-eval.yaml")  # TODO: Optionally download from same location as ckpt and chnage this logic
    model = load_model_from_config(config, "logs/2022-11-03T15-45-31_flintstones_txt2img-1p4B-train/checkpoints/epoch=000045.ckpt")  # TODO: check path
